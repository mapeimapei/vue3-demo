<template>
    ...
    hoverStep =>  {{hoverStep}}  <br />
    step ==>  {{step}}


    <div id="peiBox" v-if="false" style="width: 100%; height: 300px; background-color: #dedede; margin-bottom: 20px; margin-top: 20px;">
    ...
    <div class="throughput" v-if="false">
